...
This chapter explains the method developed to locate the occupancy sensors in a ceiling mounted sensor grid, using the  data obtained from the sensors and  information about the locations of the vertices of the grid.
