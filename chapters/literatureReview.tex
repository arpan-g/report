...
\text{\citeauthor{Hong:2013:TAS:2528282.2528302}}\text{\cite{Hong:2013:TAS:2528282.2528302}} & co-locating sensors                                                                                         & \begin{tabular}[c]{@{}c@{}}Correlation coefficient between the IMF of\\ the sensor data\end{tabular}                                                                                                                                \\ \hline
\text{\citeauthor{doi:10.1061/9780784413616.226}}\text{\cite{doi:10.1061/9780784413616.226}} & co-locating sensors                                                                                         & \begin{tabular}[c]{@{}c@{}}Correlation coefficient between the energy\\ content of the HVAC delivered air\end{tabular}                                                                                                              \\ \hline
\text{\citeauthor{Koc:2014:CLC:2674061.2674075}}\text{\cite{Koc:2014:CLC:2674061.2674075}}      & co-locating sensors                                                                                         & Correlation between the raw sensor data.                                                                                                                                                                                            \\ \hline
\text{\citeauthor{Lu:2014:SBS:2648771.2629441}}\text{\cite{Lu:2014:SBS:2648771.2629441}}      & floor maps for a house                                                                                      & \begin{tabular}[c]{@{}c@{}}clustering based on simultaneous trigger of occupancy sensors and \\connectivity between rooms is determined by \\ simultaneous triggering of sensors placed on window jamb and door.\end{tabular} \\ \hline
\text{\citeauthor{ellis2012creating}}\text{\cite{ellis2012creating}}                         & room connectivity graph                                                                                     & Transition matrix between the sensors located in different rooms.                                                                                                                                                                   \\ \hline
\text{\citeauthor{muller2014automated}}\text{\cite{muller2014automated}}                     & co-locating sensors                                                                                         & Consecutive edge triggers                                                                                                                                                                                                           \\ \hline
\text{\citeauthor{marinakis2005learning}}\text{\cite{marinakis2005learning}}                  & \begin{tabular}[c]{@{}c@{}}inferring sensor network topology\\ by assigning activity to users.\end{tabular} & \multicolumn{1}{l|}{Assigning activity to people to obtain the sensor topology}                                                                                                                                                     \\ \hline
\end{tabular}
\end{sidewaystable}
